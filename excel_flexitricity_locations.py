...
def show_flexitricity_locations_excel_format():
    """
    Display ALL unique locations with Flexitricity load curtailment/drop
...
if __name__ == "__main__":
    try:
        show_flexitricity_locations_excel_format()
    except Exception as e:
        print(f"Error: {e}") 