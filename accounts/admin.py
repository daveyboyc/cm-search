...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ('user', 'has_paid_access', 'paid_access_expiry_date', 'is_paid_access_active', 'free_access_start_time', 'reminder_email_sent', 'is_free_access_expired')
    list_filter = ('has_paid_access', 'reminder_email_sent')
    search_fields = ('user__username', 'user__email')
    readonly_fields = ('is_paid_access_active', 'is_free_access_expired', 'free_access_time_remaining')
    
    def is_free_access_expired(self, obj):
        return obj.is_free_access_expired
    is_free_access_expired.boolean = True
    is_free_access_expired.short_description = 'Free Access Expired'
